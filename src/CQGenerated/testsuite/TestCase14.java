...
public class TestCase14
{
	...
	public void step10()
	{
		...
		CQTestSuite.harness.fillCQRecordFill_Date_Range_form_Find_Transactions_screen(
		new CQRecordFill_Date_Range_form_Find_Transactions_screen(
		/**Fill_Date_Range_form*/
		new CQRecordFill_Date_Range_form(
		/**Between*/
		"",
		/**And*/
		" "
	...
	public void step11()
	{
		...
		CQTestSuite.harness.clickCQRecordFind_Transactions_button_Find_Transactions_screen_Date_Range_form(
		new CQRecordFind_Transactions_button_Find_Transactions_screen_Date_Range_form(
		)
		);
	}
	public void step12()
	{
		...
		CQTestSuite.harness.verifyCQRecordTransaction_Error__Action(
			...
			/**Error*/
			" From date is required. To date is required"
			));
	}
	@Before
	public void setUp()
	{
		CQData.setUp();
		CQTestSuite.harness.setUp("From date and To date are required");
	}
	@After
	public void tearDown()
	{
		CQTestSuite.harness.tearDown("From date and To date are required");
	}
}
