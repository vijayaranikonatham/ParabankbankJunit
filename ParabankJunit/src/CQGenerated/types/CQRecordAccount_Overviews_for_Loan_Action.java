...
public class CQRecordAccount_Overviews_for_Loan_Action implements CQJSONizeable {
public CQRecordAccount_Overviews_for_Loan_Action(){}

public CQRecordAccount_Overviews_for_Loan_Action(String Account1,String Balance_of_Account1,String Available_Amount_of_Account_1,String Account2,String Balance_Account2,String Avilable_Amount_of_Account2,String Total_Amount)
	{
	...
	public boolean equals(Object other)
	{
		...
		if (!(other instanceof CQRecordAccount_Overviews_for_Loan_Action))
		{
    
			return false;

		}
		CQRecordAccount_Overviews_for_Loan_Action otherRec = (CQRecordAccount_Overviews_for_Loan_Action) other;
