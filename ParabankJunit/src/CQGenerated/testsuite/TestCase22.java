...
public class TestCase22
{
	...
	public void step10()
	{
		...
		CQTestSuite.harness.fillCQRecordFill_Transaction_By_Date_form_Find_Transactions_screen(
		new CQRecordFill_Transaction_By_Date_form_Find_Transactions_screen(
		/**Fill_Transaction_By_Date_form*/
		new CQRecordFill_Transaction_By_Date_form(
		/**Find_By_Date*/
		"Date(MM-DD-YYYY)"
		)
		)
	...
	public void step11()
	{
		...
		CQTestSuite.harness.clickCQRecordFind_Transactions_button_Find_Transactions_screen_Transaction_By_Date_form(
		new CQRecordFind_Transactions_button_Find_Transactions_screen_Transaction_By_Date_form(
		)
		);
	}
	public void step12()
	...
	{
		CQData.setUp();
		CQTestSuite.harness.setUp("Find Transaction by Date");
	}
	@After
	public void tearDown()
	{
		CQTestSuite.harness.tearDown("Find Transaction by Date");
	}
}
