...
public class TestCase23
{
	...
	public void step10()
	{
		...
		CQTestSuite.harness.fillCQRecordFill_Find_By_Amount_form_Find_Transactions_screen(
		new CQRecordFill_Find_By_Amount_form_Find_Transactions_screen(
		/**Fill_Find_By_Amount_form*/
		new CQRecordFill_Find_By_Amount_form(
		/**Find_By_Amount*/
		"Amount"
		)
		)
	...
	public void step11()
	{
		...
		CQTestSuite.harness.clickCQRecordFind_Transactions_button_Find_Transactions_screen_Find_By_Amount_form(
		new CQRecordFind_Transactions_button_Find_Transactions_screen_Find_By_Amount_form(
		)
		);
	}
	public void step12()
	...
	{
		CQData.setUp();
		CQTestSuite.harness.setUp("Find Transaction by Amount");
	}
	@After
	public void tearDown()
	{
		CQTestSuite.harness.tearDown("Find Transaction by Amount");
	}
}
