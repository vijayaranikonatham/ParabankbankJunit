...
public class TestCase11
{
	...
	public void step10()
	{
		...
		CQTestSuite.harness.verifyCQRecordBill_Payment_Complete_Action(
			...
			/**Bill_Payment*/
			"Bill Payment to Username in the amount of $xxx from account 12345 was successful and amount $xxx should be debit from account 12345. "
			));
	}
	@Before
	public void setUp()
	{
		CQData.setUp();
		CQTestSuite.harness.setUp("Bill Payment Successfull and amount debit from account balance");
	}
	@After
	public void tearDown()
	{
		CQTestSuite.harness.tearDown("Bill Payment Successfull and amount debit from account balance");
	}
}
