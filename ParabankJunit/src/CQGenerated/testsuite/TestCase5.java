...
public class TestCase5
{
	...
	public void step7()
	{
		...
		CQTestSuite.harness.verifyCQRecordInvalid_Register_Action(
			new CQRecordInvalid_Register_Action(
	...
	{
		CQData.setUp();
		CQTestSuite.harness.setUp("Reject existing user accounts");
	}
	@After
	public void tearDown()
	{
		CQTestSuite.harness.tearDown("Reject existing user accounts");
	}
}
